            ...
            <footer className="text-center text-xl text-white  bg-black py-6 md:px-8 " >
                ...
                <div className="social-icons flex justify-center mt-2">
                    <ul className="flex justify-between space-x-4">
                        <li>
                            <a target="_blank" href="mailto:shuvadiptadas8820@gmail.com" className="group">
                        ...
                        <li className="group relative">
                            <a target="_blank" href="https://www.instagram.com/its_shuvadipta/" className="relative z-10 flex items-center justify-center w-8 h-8 text-white border-2 border-white rounded-full">
                                <FaInstagram />
                            </a>
                        ...
                        <li>
                            <a target="_blank" href="https://www.linkedin.com/in/shuvadipta-das-915b28216/" className="group">
                                <FaLinkedin className="text-white border-2 border-white rounded-full w-8 h-8  items-center justify-center transition duration-300 ease-in group-hover:text-gray-100 group-hover:border-gray-100 group-hover:bg-blue-600" />
                            </a>
                        </li>

                        <li>
                            <a target="_blank" href="https://github.com/5h0ov" className="group">
                                <FaGithub className="text-white border-2 border-white rounded-full w-8 h-8  items-center justify-center transition duration-300 ease-in group-hover:text-gray-100 group-hover:border-gray-100 group-hover:bg-gray-600" />
                            </a>
                        </li>
                    </ul>
                </div>
